defmodule AuthenticationWeb.Api.ProductController do
  use AuthenticationWeb, :controller

  alias Authentication.Products
  alias Authentication.Products.Product

  action_fallback AuthenticationWeb.FallbackController
