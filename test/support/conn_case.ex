defmodule AuthenticationWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Authentication.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Authentication.Accounts.generate_user_session_token(user)
  ...
  def create_user_and_assign_valid_jwt(%{conn: conn}) do
    user = Authentication.AccountsFixtures.user_fixture()
    {:ok, jwt, _full_claims} = Authentication.Guardian.encode_and_sign(user, %{})
